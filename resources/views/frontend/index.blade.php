...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <a href="{{url('/')}}" class="logo me-auto"><img src="{{ asset('frontend/assets/img/logo.png') }}"
                    alt=""></a>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="image col-lg-6 order-1 order-lg-2"
                        style='background-image: url("{{ asset('frontend/assets/img/features.jpg') }}");'
        ...
        <section id="appointment" class="appointment section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    ...
                    <p>unique Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum
                        quidem. Sit
                        sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias
                        ea. Quia fugiat sit in iste officiis commodi quidem hic quas.</p>
                </div>
                ...
                <form action="{{ route('home.store') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group  mt-3">
                            ...
                            <input type="text" name="temporary_address" class="form-control"
                                id="temporary_address" placeholder="Temporary Address" required>
                        </div>
                        <div class="col-md-4 form-group  mt-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group mt-3">
                            <label for="">Select Which Department</label>
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group mt-3">
                            <label for="">Select Doctor Name</label>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div id="schedule_list" class="mt-3"></div>
                        </div>
                    </div>

                    <div class="form-group mt-3">
                        <label for="">Appointment Message</label>
                        <textarea class="form-control" name="appointment_message" rows="5" placeholder="Appoinment Message"></textarea>
                    </div>
                    <div class="form-group mt-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="fade-up" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('frontend/assets/img/doctors/doctors-2.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="fade-up" data-aos-delay="300">
                            <div class="member-img">
                                <img src="{{ asset('frontend/assets/img/doctors/doctors-3.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="fade-up" data-aos-delay="400">
                            <div class="member-img">
                                <img src="{{ asset('frontend/assets/img/doctors/doctors-4.jpg') }}" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dept_name').change(function() {
                ...
                var url = " {{ route('getDoctor', ':dept_name') }} ";
                url = url.replace(':dept_name', dept_name);
                if (dept_name) {
                    $.ajax({
                        url: url,
                        type: 'GET',
                        ...
                        success: function(res) {
                            ...
                            res.forEach(function(getDoctor_id) {
                                doctor_id.append(
                                    '<option value="' + getDoctor_id['id'] + '">' +
                                    getDoctor_id['first_name'] + ' ' + getDoctor_id[
                                        'middle_name'] + ' ' + getDoctor_id[
                                        'last_name'] + '</option>'
                                );
                            })
