...
<div class="breadcrumb_wrapper">
    ...
    <div>
        <a href="{{ route('doctorTrash') }}" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"> <i
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="{{ route('doctor.show', $data->id) }}" data-toggle="tooltip"
                                            data-placement="top" title="View" class="text-success"><i
                                                class="far fa-eye"></i></a>
                                        <a href="{{ route('doctor.edit', $data->id) }}" data-toggle="tooltip"
                                            data-placement="top" title="Edit" class="text-primary"><i
